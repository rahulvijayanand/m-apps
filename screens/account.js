    ...
    {id:3,title:"Orders",name:require("../assets/Vector-7.png")},
     {id:4,title:"Saved Cards",name:require("../assets/Group-2.png")},
      {id:5,title:"Wishlist",name:require("../assets/Vector-2.png")},
       {id:6,title:"Manage Referrals",name:require("../assets/Group-300.png")},
        {id:7,title:"Notifications",name:require("../assets/Vector-11.png")},
         {id:8,title:"Terms & Policies",name:require("../assets/Vector-12.png")},
          {id:9,title:"Customer Support",name:require("../assets/Group302.png")}
  
]
export default function App() {
  return (
    <View style={{flex:1, paddingTop: StatusBar.currentHeight + 10,backgroundColor: "#fff",}}>
     ...
     <View style={styles.display}>
        <Image
          ...
          style={styles.icon}
        />
        <Text style={{fontSize:28,bottom:3}}>My Account</Text>
      </View>
      ...
      <Text style={{marginHorizontal:"5%",fontSize:20}}>Arun Kumar</Text>
      <Text style={{marginHorizontal:"3%",color:"gray"}}>+9197854XXXXX</Text>
      </View>
      </View>
 ...
 const styles = StyleSheet.create({
        ...
        profilepic:{
          height:65,width:65,marginLeft:"15%",
           borderWidth:0.5,borderRadius:50,elevation:10,shadowColor:"black",shadowOffset:{width:0,height:8},shadowOpacity:0.16,shadowRadius:16
        } ,
        display: {
          flexDirection: "row",
          marginLeft: 20,
